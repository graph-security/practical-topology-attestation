...
static char *DEFAULT_ISSUER = "topographia-123";
...
int main(int argc, char *argv[]) {
    ...
    pk = e_2_i_TSS_DAA_PK( &key_pair->publicKey);
    private_key = (TSS_DAA_PRIVATE_KEY *) &key_pair->secretKey;
    private_key->productPQprime = key_pair->secretKey.productPQprime;
    private_key->productPQprimeLength =  key_pair->secretKey.productPQprimeLength;
    private_key->versionInfo = key_pair->versionInfo;
