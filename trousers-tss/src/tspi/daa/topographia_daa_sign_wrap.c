...
SWIGEXPORT jstring JNICALL Java_uk_ac_ncl_cascade_daa_sign_topographia_1daa_1signJNI_getSignResult(JNIEnv *jenv, jclass jcls) {
  jstring jresult = 0 ;
  char *result = 0 ;
  
  (void)jenv;
  (void)jcls;
  result = (char *)getSignResult();
  if (result) jresult = (*jenv)->NewStringUTF(jenv, (const char *)result);
  return jresult;
}


SWIGEXPORT void JNICALL Java_uk_ac_ncl_cascade_daa_sign_topographia_1daa_1signJNI_setSignResult(JNIEnv *jenv, jclass jcls, jstring jarg1) {
  char *arg1 = (char *) 0 ;
...
SWIGEXPORT jint JNICALL Java_uk_ac_ncl_cascade_daa_sign_topographia_1daa_1signJNI_tp_1daa_1sign(JNIEnv *jenv, jclass jcls, jobjectArray jarg1) {
  jint jresult = 0 ;
  int arg1 ;
  char **arg2 ;
  jstring *jsarray1 ;
  ...
  result = (int)tp_daa_sign(arg1,arg2);
  jresult = (jint)result; 
