...
int main (int argc, char **argv) {
 ...
 tmp5(3)=%s tmp6(10)=%s\n",
	...
	printf("   (1 << 10) >> 5 = [* (2^10) / (2^5) *] -> %s\n", bi_2_dec_char( bi_div( bi_tmp1,bi_mod_exp_si( bi_tmp2, bi_2, bi_set_as_si( bi_tmp3, 10), 2000),bi_mod_exp_si( bi_tmp4, bi_2, bi_set_as_si( bi_tmp5,   5), 2000) )));

	printf("(1 << 10) >> 5 = (2^10) / (1<<5)  -> %d\n", bi_equals( bi_shift_right( bi_tmp, ( bi_shift_left( bi_tmp1, bi_1, 10)), 5),bi_div( bi_tmp2,bi_mod_exp_si( bi_tmp3, bi_2, bi_set_as_si( bi_tmp4, 10), 2000),bi_mod_exp_si( bi_tmp5, bi_2, bi_set_as_si( bi_tmp6,   5), 2000))));
