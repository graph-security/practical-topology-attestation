...
public class SignerOrchestratorBC implements IMessagePartner, IURNGoverner {
    ...
    public SignerOrchestratorBC(final ExtendedKeyPair extendedKeyPair, final IMessageGateway messageGateway) {
    ...
    public void daaSignVerifier() throws IOException {
        GSMessage daaMsg = signer.receiveMessage();
        Map<URN, Object> messageElements = daaMsg.getMessageElements();
        NG = (String) messageElements.get(URN.createZkpgsURN("recipient.NG"));
        System.out.println("received NG: " + NG);
    }
    ...
    public void round2(BigInteger e_i) throws IOException, ProofStoreException, VerificationException, NoSuchAlgorithmException {
