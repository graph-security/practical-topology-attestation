...
public class RecipientOrchestratorBC implements IMessagePartner {
	...
	public void daaSignProver() throws IOException {
		...
		String pseudonym = daaCredential.getCapitalNi();
		Map<URN, Object> messageElements = new HashMap<>();
		//send NG pseudonym for the binding credential
		messageElements.put(URN.createZkpgsURN("recipient.NG"),pseudonym);
	...
	public void round1() throws IOException, ProofStoreException, NoSuchAlgorithmException {
		...
		// perform daa sign for the device credential
		String pseudonym = daaSign();
